...
@property (nonatomic,assign)  NSInteger mCorrect;
@property (nonatomic,assign)  NSInteger oldX;
@property (nonatomic,assign)  NSInteger oldY;
@property (nonatomic,assign)  NSInteger mId;
@property (nonatomic,assign)  id element_data_obj;
@property (nonatomic,assign)  id element_data_obj_click;
